<%-- 
    Document   : listOfAppointments
    Created on : 15-Jan-2020, 21:35:37
    Author     : 3rafad60
--%>
...
<html>
    <head>
        ...
        <title>List of appointments JSP Server Page</title>
    </head>
    <body>
        ...
        <a href="../projectfacadeweb/formAddAppointment.jsp">Add an appointment</a><br><br>
        <div>
